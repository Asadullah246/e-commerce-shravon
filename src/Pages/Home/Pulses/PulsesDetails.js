            ...
            <div className="hero min-h-screen  ">
                <div className="hero-content flex-col">
                    <form onSubmit={hendleCart}>
                        ...
                        <div className="">
                            <input value={value} onChange={handleChange} name="quantity" placeholder='Quantity(kg)' className="input input-bordered w-96 max-w-xs  bg-gray-100 text-black " />

                            {/* <p>{`You selected ${value * price}`}</p> */}

                        </div><br />
                        <div className="">
                            <input name="" value={`${value * price} TK`} className="input input-bordered w-96 max-w-xs  bg-gray-100 text-black " />
                        ...
                        <div className="">
                            <input name="Address" type="text" placeholder="Address" className="input input-bordered w-96 max-w-xs  bg-gray-100  " required />

                        </div>
                        <div className='mt-3'>
                            <span className="label-text  ">Add to the cart & confirm your order. </span> <br />
                            <button className="btn mt-2   w-full max-w-xs drop-shadow-lg mb-10 btn-neutral ">Add to Catr</button>
                        </div>
