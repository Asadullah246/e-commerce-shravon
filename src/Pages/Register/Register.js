                    ...
                    <div className="hero-overlay bg-opacity-60 rounded-lg">
                        <div className="hero-content flex-col lg:flex-row-reverse  lg:p-10 rounded-md shadow-2xl ">
                            <div className="text-center ">
                                <h1 className="text-5xl font-bold mb-5 text-white">Signup now!</h1>
                                <p className="py-6 lg:px-6 text-white text-justify">BulkPluses is a wholesale marketplace where you can buy pulses in large quantities and also at a reasonable price. We provide delivery of our pulses in 64 districts of Bangladesh. You will get the best quality and clean pulses from us. To get these best quality pulses, you can order them on our website also you can contact us through our contact number.</p>
                            ...
                            <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                                <Form onSubmit={userDetail} className="card-body">
                                    <div className="form-control">
                                        ...
                                        <input type="text" name='name' placeholder="name" className="input input-bordered bg-gray-50  " required />
                                    </div>
                                    <div className="form-control">
                                        <label className="label">
                                    ...
                                    <div className="form-control mt-2">
                                        <button onClick={handleGoogleSignIn} className="btn    font-bold  ">Signup With Google<img src={googleLogo} alt="google logo" className=' h-6 ml-6' /></button>
                                    </div>
                                    <div>
